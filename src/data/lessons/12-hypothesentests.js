  ...
  examples: [
    ...
    },
    {
      ...
      steps: [
        ...
        { key: 'examples.crash_rate.step3', formula: 'P(X \\geq 8) = 1 - P(X \\leq 7) \\approx 0{,}049' },
        { key: 'examples.crash_rate.step4', formula: '0{,}049 < 0{,}05 \\;\\Rightarrow\\; H_0 \\text{ ablehnen: Crash-Rate ist signifikant erhöht}' },
      ],
