...
export const exercise = {
  ...
  validate: (answers) => {
    const stepResults = [
      validateStep(answers.outer, ACCEPTED.outer),
      validateStep(answers.inner, ACCEPTED.inner),
      validateStep(answers.douter, ACCEPTED.douter),
      validateStep(answers.dinner, ACCEPTED.dinner),
