export const batch11a = {
  '11-ableitungsregeln': {
    ...
    explanation: {
      ...
      quotient_rule: 'Für Brüche von Funktionen gibt es die Quotientenregel. Merkhilfe: "NAZ minus ZAN durch N Quadrat" (N = Nenner, Z = Zähler, A = Ableitung). Anders als bei der Produktregel kommt es hier auf die Reihenfolge an — das Minus macht die Formel unsymmetrisch:',
      chain_rule: 'Bei verschachtelten Funktionen — also einer Funktion in einer Funktion — brauchst du die Kettenregel. Du leitest "von außen nach innen" ab und multiplizierst mit der inneren Ableitung:',
    },
    concepts: {
      power_rule: {
        title: 'Potenzregel',
      ...
      product_rule: {
        title: 'Produktregel',
        desc: 'Für das Produkt zweier Funktionen: Erste ableiten mal Zweite plus Erste mal Zweite ableiten. Unverzichtbar, sobald zwei variable Ausdrücke multipliziert werden.',
      },
      quotient_rule: {
        title: 'Quotientenregel',
        desc: 'Für Brüche: Nenner mal Ableitung des Zählers, minus Zähler mal Ableitung des Nenners, geteilt durch den quadrierten Nenner. Das Minus ist der Unterschied zur Produktregel — und die häufigste Fehlerquelle. Überall dort nötig, wo etwas "pro" etwas anderem steht: Stückkosten, Geschwindigkeit, Konzentration.',
      },
      chain_rule: {
        title: 'Kettenregel',
        desc: 'Äußere Funktion ableiten, innere stehen lassen, dann mit der Ableitung der inneren multiplizieren. Das Herzstück von Backpropagation in neuronalen Netzen.',
      },
    },
    examples: {
      power_sum: {
        ...
        step2: 'Potenzregel auf jeden Term anwenden: Exponent als Faktor, Exponent minus 1. Konstante $-7$ fällt weg:',
      ...
      quotient_rule: {
        title: 'Gebrochen-rationale Funktion mit der Quotientenregel ableiten',
        context: 'Amir misst, wie viele Anfragen sein Server pro laufender Sekunde schafft — eine Größe pro einer anderen, also ein Bruch.',
        step1: 'Zuerst benennst du Zähler und Nenner. Wer das überspringt, vertauscht sie später:',
        step2: 'Beide einzeln ableiten — das ist der leichte Teil:',
        step3: 'Jetzt einsetzen: Nenner mal Ableitung des Zählers, minus Zähler mal Ableitung des Nenners, alles durch $v^2$:',
        step4: 'Ausmultiplizieren und zusammenfassen. Der Nenner bleibt als Quadrat stehen, er wird nicht ausmultipliziert:',
        amir_comment: 'Wichtig: Der Nenner bleibt $(x-1)^2$. Ich habe ihn früher immer brav ausmultipliziert und mir damit das Kürzen verbaut. In der Kurvendiskussion willst du die Nullstellen des Nenners sehen können — als Faktor, nicht als Polynom.',
      },
      chain_rule: {
        title: 'Verschachtelte Funktion mit Kettenregel',
        context: 'Amir leitet eine Aktivierungsfunktion ab, die eine Komposition enthält.',
        ...
        step4: 'Aufgeräumt — Faktor $4x$ nach vorne gezogen:',
    ...
    mistakes: {
      ...
      chain_rule_forgotten: {
        ...
        amir_warning: 'Stell dir vor, in einem Neural Network vergisst du bei einer Schicht die innere Ableitung — der Gradient wäre komplett falsch und das Modell lernt Unsinn. Die Kettenregel ist nicht optional!',
      },
      quotient_sign: {
        wrong: 'Zähler der Quotientenregel vertauscht: $u \\cdot v\' - u\' \\cdot v$',
        correct: 'Nenner mal Ableitung des Zählers zuerst: $u\' \\cdot v - u \\cdot v\'$',
        why: 'Die Produktregel ist symmetrisch — du darfst die beiden Summanden vertauschen, das Ergebnis bleibt gleich. Bei der Quotientenregel steht ein Minus, und damit ist die Reihenfolge fest. Vertauschst du sie, bekommst du exakt das Negative der richtigen Ableitung. Das Tückische daran: der Term sieht plausibel aus, du rechnest korrekt weiter, und trotzdem stimmt am Ende jedes Vorzeichen nicht. Aus einem Hochpunkt wird ein Tiefpunkt.',
        amir_warning: 'Mach die Probe an einer einfachen Stelle. Bei $f(x) = \\frac{x}{x+1}$ ist die Funktion überall steigend, also muss $f\'$ positiv sein. Kommt bei dir etwas Negatives heraus, hast du den Zähler verdreht — das kostet dich zehn Sekunden und rettet die ganze Aufgabe.',
      },
    },
  },
