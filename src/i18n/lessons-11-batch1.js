export const batch11a = {
  '11-ableitungsregeln': {
    story: {
      intro: 'Amirs ML-Modell fuer DataPulse liefert brauchbare Songempfehlungen — aber das Training dauert ewig. "Gradient Descent ist im Prinzip nichts anderes als Ableitungen", erklaert ihm seine Mathe-Professorin. "Wenn du verstehst, wie Ableitungsregeln funktionieren, verstehst du auch, warum dein Modell lernt." Amir beschliesst, die Regeln systematisch durchzuarbeiten.',
      challenge: 'Amir will verstehen, wie sein ML-Modell intern die Verlustfunktion ableitet — dafuer braucht er Potenz-, Summen-, Produkt- und Kettenregel.',
      outro: 'Amir hat jetzt ein solides Fundament: Potenzregel fuer einfache Terme, Summen- und Faktorregel fuer zusammengesetzte Ausdruecke, Produktregel fuer Multiplikationen und die Kettenregel fuer verschachtelte Funktionen. "Jetzt verstehe ich endlich, was PyTorch im Hintergrund mit Autograd macht", sagt er zufrieden.',
    },
    objectives: {
    ...
    explanation: {
      ...
      constant_factor: 'Konstante Faktoren bleiben beim Ableiten erhalten, und bei Summen darfst du gliedweise ableiten. Das macht zusammengesetzte Terme uebersichtlich:',
      amir_tip: 'In meinem ML-Code stecken ueberall Summen und Faktoren — die Verlustfunktion ist eine riesige Summe ueber alle Datenpunkte. Dass ich jeden Term einzeln ableiten darf, macht Backpropagation ueberhaupt erst moeglich!',
      ...
      quotient_rule: 'Fuer Brueche von Funktionen gibt es die Quotientenregel. Merkhilfe: "NAZ minus ZAN durch N Quadrat" (N = Nenner, Z = Zaehler, A = Ableitung):',
    ...
    concepts: {
      power_rule: {
        title: 'Potenzregel',
        desc: 'Die Grundregel: Exponent wird zum Faktor, Exponent sinkt um 1. Gilt auch fuer negative und gebrochene Exponenten, z.B. $\\frac{1}{x} = x^{-1}$.',
      },
      sum_rule: {
      ...
      product_rule: {
        title: 'Produktregel',
        desc: 'Fuer das Produkt zweier Funktionen: Erste ableiten mal Zweite plus Erste mal Zweite ableiten. Unverzichtbar, sobald zwei variable Ausdruecke multipliziert werden.',
      },
      chain_rule: {
        title: 'Kettenregel',
        desc: 'Aeussere Funktion ableiten, innere stehen lassen, dann mit der Ableitung der inneren multiplizieren. Das Herzstuck von Backpropagation in neuronalen Netzen.',
      },
    },
    examples: {
      power_sum: {
        ...
        amir_comment: 'Genau so sieht der Gradient meiner polynomialen Features aus. Jeder Term liefert seinen Beitrag zur Steigung — und PyTorch macht das automatisch fuer Tausende Parameter gleichzeitig.',
      },
      chain_rule: {
        ...
        step2: 'Zerlegung in aeussere Funktion $f(u) = u^3$ und innere Funktion $g(x) = 2x^2 + 1$:',
        step3: 'Aeussere ableiten (Potenzregel auf $u^3$), innere stehen lassen, mal innere Ableitung ($4x$):',
    ...
    realworld: {
      ...
      marginal_cost: {
        ...
        desc: 'Die Ableitung der Kostenfunktion $K(x)$ gibt die Grenzkosten: Was kostet eine weitere produzierte Einheit? Unternehmen nutzen das taeglich fuer Preiskalkulation.',
      },
      acceleration: {
    ...
    mistakes: {
      power_rule_constant: {
        ...
        why: 'Eine Konstante hat keine Steigung — sie aendert sich nicht. Denk an $f(x) = 5$: Das ist eine waagerechte Linie, also ist die Steigung ueberall 0. Das gilt fuer jede Zahl ohne $x$.',
  ...
  '11-kurvendiskussion': {
    ...
    objectives: {
      ...
      inflection_points: 'Wendepunkte berechnen und deren Bedeutung fuer den Kurvenverlauf verstehen',
    ...
    explanation: {
      ...
      amir_tip: 'Die Loss-Landschaft meines Modells hat viele lokale Minima. Mit der Kurvendiskussion kann ich pruefen, ob ein kritischer Punkt wirklich ein Minimum ist — oder nur ein Sattelpunkt, an dem der Optimizer haengenbleibt.',
      inflection: 'Wendepunkte markieren den Uebergang zwischen Links- und Rechtskruemmung. Hier aendert sich das Kruemmungsverhalten — die zweite Ableitung wechselt das Vorzeichen:',
    ...
    examples: {
      complete_analysis: {
        ...
        context: 'Amir untersucht eine kubische Funktion — aehnlich wie Verlustfunktionen mit mehreren Extrema.',
        step1: 'Gegeben ist die Funktion — wir analysieren sie komplett:',
        step2: 'Erste Ableitung bilden und Nullstellen bestimmen (notwendige Bedingung fuer Extrema):',
        ...
        step4: 'Wendepunkt ueber $f\'\' = 0$ bestimmen und mit dritter Ableitung bestaetigen:',
        amir_comment: 'Genau so analysiere ich die Loss-Landschaft: Erst kritische Punkte finden, dann pruefen ob Minimum oder Sattelpunkt. Bei hochdimensionalen Funktionen macht mein Optimizer das numerisch — aber das Prinzip ist identisch.',
      },
      graph_properties: {
        title: 'Symmetrie und Extrema nutzen',
        context: 'Eine symmetrische Funktion — die Haelfte der Arbeit entfaellt durch Symmetrie.',
        step1: 'Gegeben ist eine Funktion 4. Grades — wir pruefen zuerst Symmetrie:',
        step2: 'Einsetzen von $-x$: Alle Exponenten gerade, also $f(-x) = f(x)$ — achsensymmetrisch! Extrema kommen symmetrisch vor:',
        step3: 'Erste Ableitung Null setzen — durch Symmetrie genuegt es, die positiven Loesungen zu finden:',
        step4: 'Funktionswerte berechnen — dank Symmetrie gilt $f(\\sqrt{2}) = f(-\\sqrt{2})$:',
        amir_comment: 'Symmetrie in Daten ist Gold wert: Wenn ich weiss, dass meine Verlustfunktion symmetrisch ist, muss ich nur die Haelfte des Parameterraums durchsuchen. Das halbiert die Trainingszeit!',
      },
    },
    realworld: {
      data_distribution: {
      ...
      population_growth: {
        ...
        desc: 'Der Wendepunkt einer Wachstumskurve markiert den Moment, ab dem das Wachstum abnimmt. Epidemiologen nutzen genau diese Analyse fuer Infektionskurven.',
      },
    },
    mistakes: {
      extrema_without_check: {
        ...
        why: 'Bei $f(x) = x^3$ ist $f\'(0) = 0$, aber kein Extremum — sondern ein Sattelpunkt! Du MUSST die hinreichende Bedingung ($f\'\' \\neq 0$ oder Vorzeichenwechsel von $f\'$) pruefen.',
        amir_warning: 'In hoeheren Dimensionen heissen solche Stellen "Saddle Points" — der Optimizer bleibt dort haengen und denkt, er hat ein Minimum gefunden. Immer die zweite Ableitung checken!',
      },
      inflection_second_only: {
        wrong: '$f\'\'(x_0) = 0$ reicht fuer einen Wendepunkt',
        ...
        amir_warning: 'Gleiche Falle wie bei Extrema: Die notwendige Bedingung allein reicht nie. Immer die hinreichende Bedingung pruefen — sonst vertraust du einem falschen Ergebnis.',
      },
    },
  },
  ...
  '11-extremwertaufgaben': {
    story: {
      intro: 'DataPulse soll auf dem Handy laufen — aber Amirs Modell braucht zu viel Speicher. "Du musst die Netzwerkarchitektur optimieren", sagt seine Teamkollegin Sara. "Maximale Genauigkeit bei minimalem Speicherverbrauch." Amir erkennt: Das ist eine klassische Extremwertaufgabe — eine Groesse optimieren, waehrend eine andere Groesse eingeschraenkt ist.',
      challenge: 'Amir will die beste Modellarchitektur finden: maximale Vorhersagequalitaet unter der Nebenbedingung begrenzter Rechenressourcen.',
      outro: 'Amir hat das Prinzip verstanden: Zielfunktion aufstellen, Nebenbedingung einsetzen, auf eine Variable reduzieren, ableiten, Null setzen, pruefen. "Ob Dosendimensionen oder Modellparameter — das Schema ist immer dasselbe", stellt er fest. Sein Modell passt jetzt auf 50 MB.',
    },
    objectives: {
      ...
      verify_extremum: 'Mit der zweiten Ableitung pruefen, ob ein Maximum oder Minimum vorliegt, und Randwerte beruecksichtigen',
    },
    explanation: {
      intro: 'Bei Extremwertaufgaben geht es immer um dasselbe: Eine Groesse soll moeglichst gross oder klein werden (Zielfunktion), waehrend eine Einschraenkung gilt (Nebenbedingung):',
      strategy: 'Die Strategie ist immer gleich: (1) Zielfunktion aufstellen — was soll optimiert werden? (2) Nebenbedingung finden — welche Einschraenkung gilt? (3) Nebenbedingung nach einer Variablen aufloesen und in die Zielfunktion einsetzen. (4) Ableiten, Null setzen, pruefen.',
    ...
    concepts: {
      target_function: {
        title: 'Zielfunktion',
        desc: 'Die Groesse, die optimiert werden soll — maximaler Gewinn, minimale Oberflaeche, beste Genauigkeit. Haengt anfangs oft von zwei Variablen ab.',
      },
      constraint: {
    ...
    examples: {
      can_volume: {
        ...
        context: 'Eine zylindrische Dose soll 330 ml fassen — bei moeglichst wenig Blech.',
        ...
        step4: 'Zweite Ableitung pruefen: Positiv bedeutet Minimum — wir haben tatsaechlich die sparsamste Dose gefunden:',
      ...
      profit_max: {
        ...
        context: 'Ein Startup will den optimalen Preis fuer sein Abo-Modell finden.',
        ...
        step3: 'Zweite Ableitung ist negativ — also ein Maximum. Der Gewinn wird hier tatsaechlich maximal:',
        step4: 'Maximalen Gewinn berechnen durch Einsetzen:',
        amir_comment: 'Preisoptimierung ist ein Klassiker in Data Science. Bei DataPulse koennten wir die optimale Abo-Stufe genauso berechnen — Gewinn maximieren unter der Bedingung, dass Nutzer nicht abspringen.',
      },
    },
    realworld: {
      hyperparameter: {
        title: 'Hyperparameter-Optimierung',
        desc: 'Die Lernrate $\\alpha$ im Gradient Descent muss optimal gewaehlt werden: Zu gross = Divergenz, zu klein = ewig langsam. Das optimale $\\alpha$ minimiert den Validierungsfehler.',
      },
      packaging: {
        title: 'Verpackungsdesign',
        desc: 'Minimaler Materialverbrauch bei festem Volumen — genau das loesen Ingenieure taeglich. Jede Getraenkedose, jeder Karton ist das Ergebnis einer Extremwertaufgabe.',
      },
      solar_panel: {
    ...
    mistakes: {
      no_constraint: {
        ...
        why: 'Mit zwei Variablen kannst du nicht einfach nach $x$ ableiten — $y$ aendert sich mit! Du MUSST die Nebenbedingung nutzen, um $y$ durch $x$ auszudruecken. Erst dann haengt alles von einer Variablen ab.',
      ...
      no_boundary: {
        ...
        amir_warning: 'In der Praxis hat jeder Parameter einen erlaubten Bereich. Meine Lernrate darf nicht negativ sein, die Batchgroesse nicht ueber den GPU-Speicher hinaus. Randwerte pruefen ist Pflicht!',
      },
    },
  },
  ...
  '11-integralrechnung': {
    story: {
      intro: 'DataPulse laeuft — aber Amir braucht eine neue Metrik: Wie viele Songs hoeren Nutzer insgesamt pro Woche? Er hat die Hoerrate $r(t)$ als Funktion der Zeit, aber er braucht die Gesamtanzahl. "Rate mal Zeit ergibt Menge — aber die Rate aendert sich staendig", gruebelst Amir. Sein Kumpel Kai grinst: "Klingt nach einem Integral."',
      challenge: 'Amir will aus der zeitabhaengigen Hoerrate $r(t)$ die Gesamtzahl gehoerter Songs berechnen — das fuehrt ihn zur Integralrechnung.',
    ...
    objectives: {
      antiderivative: 'Stammfunktionen mit der Potenzregel rueckwaerts bilden und die Integrationskonstante $C$ verstehen',
    ...
    explanation: {
      ...
      power_rule_integral: 'Die Potenzregel rueckwaerts: Exponent um 1 erhoehen und durch den neuen Exponenten teilen. Das funktioniert fuer alle $n \\neq -1$:',
      amir_tip: 'Integration ist wie Aggregation in Datenbanken: Ableitung gibt die momentane Aenderungsrate, Integration summiert alles auf. Wenn ich die Downloads pro Stunde kenne, gibt mir das Integral die Gesamtdownloads ueber einen Zeitraum.',
      ...
      area_interpretation: 'Geometrisch ist das bestimmte Integral die Flaeche zwischen Kurve und $x$-Achse. Achtung: Flaechen unterhalb der $x$-Achse zaehlen negativ! Fuer die echte Flaeche brauchst du den Betrag:',
    },
    concepts: {
      antiderivative: {
        title: 'Stammfunktion',
      ...
      fundamental_theorem: {
        ...
        desc: 'Verbindet Ableitung und Integral: Ableiten und Integrieren sind Umkehroperationen. Das bestimmte Integral laesst sich ueber die Stammfunktion berechnen.',
      },
    },
    examples: {
      area_calculation: {
        title: 'Flaeche zwischen Parabel und $x$-Achse',
        context: 'Amir visualisiert die Verteilung von Hoerzeit als Flaeche unter einer Kurve.',
        step1: 'Funktion und Nullstellen bestimmen — das sind unsere Integrationsgrenzen:',
        step2: 'Stammfunktion bilden mit der Potenzregel rueckwaerts:',
        step3: 'Bestimmtes Integral berechnen: Obere Grenze einsetzen minus untere Grenze einsetzen:',
        step4: 'Das Integral ist negativ, weil die Parabel unterhalb der $x$-Achse liegt. Fuer die Flaeche den Betrag nehmen:',
      ...
      distance_from_velocity: {
        ...
        step2: 'Die Gesamtstrecke ist das Integral der Geschwindigkeit ueber die Zeit:',
    ...
    realworld: {
      data_aggregation: {
        title: 'Datenaggregation ueber Zeit',
        desc: 'Wenn die Datenrate $r(t)$ bekannt ist, liefert das Integral die Gesamtmenge ueber einen Zeitraum. So berechnen Streaming-Dienste monatliche Hoerminuten aus sekuendlichen Daten.',
      },
      energy_consumption: {
    ...
    mistakes: {
      constant_forgotten: {
        ...
        why: 'Wenn $F\'(x) = 2x$, dann ist sowohl $x^2$ als auch $x^2 + 7$ eine Stammfunktion. Das $+C$ repraesentiert alle moeglichen Stammfunktionen. Beim bestimmten Integral kuerzt sich $C$ raus — dort darfst du es weglassen.',
        amir_warning: 'In der Praxis ist $C$ die Anfangsbedingung: Wie viele Songs hatte der Nutzer schon gehoert, bevor wir angefangen haben zu messen? Ohne $C$ fehlt der Startwert, und deine Berechnung startet bei Null statt beim echten Wert.',
      },
      negative_area: {
        wrong: 'Integral direkt als Flaeche interpretieren, auch wenn negativ',
        correct: 'Fuer echte Flaechen den Betrag der Integralwerte nehmen',
        ...
        amir_warning: 'Stell dir vor, du berechnest die Gesamthoerzeit und bekommst ein negatives Ergebnis — das waere offensichtlich falsch. Bei Flaechenproblemen immer pruefen, ob die Funktion das Vorzeichen wechselt, und Teilintervalle separat berechnen!',
      },
    },
  },
};
