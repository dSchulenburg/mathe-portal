export const batch1 = {
  '10-quad-gleichungen': {
    ...
    concepts: {
      pq_formula: {
        title: 'pq-Formel',
        desc: 'Das Standardwerkzeug für quadratische Gleichungen in Normalform. Funktioniert immer — du brauchst nur $p$ (Koeffizient vor $x$) und $q$ (konstantes Glied).',
      },
      completing_square: {
      ...
      discriminant: {
        title: 'Diskriminante',
        desc: 'Der Ausdruck unter der Wurzel in der pq-Formel: $D > 0$ ergibt zwei Lösungen, $D = 0$ ergibt genau eine, $D < 0$ bedeutet keine reelle Lösung.',
      },
      factoring: {
        title: 'Faktorisieren',
    ...
    examples: {
      pq_application: {
        title: 'Gleichung mit der pq-Formel lösen',
        ...
        step3: 'Werte in die pq-Formel einsetzen und Schritt für Schritt ausrechnen:',
        step4: 'Zwei Lösungen — Lumi trifft die Plattform an zwei Stellen:',
        mia_comment: 'Zwei Lösungen ergeben Sinn: Lumi springt bei $x = 1$ hoch und landet bei $x = 3$ wieder. Der Abschnitt dazwischen ist der Flug!',
      },
      completing_square: {
        title: 'Lösen durch quadratische Ergänzung',
        context: 'Tim will die Gleichung ohne pq-Formel lösen — als Alternative.',
    ...
    realworld: {
      ...
      rocket: {
        title: 'Raketenstarts',
        desc: 'Die Höhe einer Rakete nach dem Start folgt einer quadratischen Funktion (solange der Treibstoff reicht). Wann erreicht sie 1000 m? Quadratische Gleichung!',
      },
    },
    mistakes: {
      not_zero: {
  ...
  '10-trigonometrie': {
    story: {
      intro: 'Mia arbeitet am Leuchtturm-Level von Hafenlichter. Der Leuchtturm strahlt einen Lichtkegel über den Hafen, und Lumi muss sich im Schatten verstecken. "Ich muss berechnen, wie weit der Lichtkegel bei einem bestimmten Winkel reicht", sagt Mia. Tim zeigt auf ein rechtwinkliges Dreieck, das der Lichtkegel mit dem Boden bildet. "Das ist Trigonometrie — Sinus, Kosinus und Tangens."',
      challenge: 'Mia braucht die Reichweite des Lichtkegels bei verschiedenen Winkeln, um den Schattenbereich zu programmieren.',
      outro: 'Der Leuchtturm dreht sich langsam, und der Lichtkegel wandert über den Hafen. Dank Sinus und Kosinus berechnet Mias Code in Echtzeit, welche Bereiche beleuchtet sind. Lumi schleicht von Schatten zu Schatten — das Level ist richtig spannend geworden!',
    },
    objectives: {
    ...
    concepts: {
      ...
      unit_circle: {
        title: 'Einheitskreis',
        desc: 'Ein Kreis mit Radius 1. Jeder Punkt auf dem Kreis hat die Koordinaten $(\\cos(\\alpha) \\mid \\sin(\\alpha))$. Damit lassen sich sin und cos für alle Winkel definieren — nicht nur für spitze.',
      },
    },
    examples: {
      height_tan: {
        ...
        mia_comment: 'Im Spiel läuft das in Echtzeit: Winkel des Lichtkegels ändert sich, und mein Code berechnet sofort die neue Reichweite. Tangens ist dafür perfekt!',
      },
      unit_circle: {
    ...
    mistakes: {
      ...
      deg_rad: {
        ...
        correct: 'Immer DEG-Modus prüfen bei Gradangaben',
  ...
  '10-exp-wachstum': {
    ...
    concepts: {
      ...
      euler_base: {
        ...
        desc: 'Die Basis $e \\approx 2{,}718$ ist besonders: Die Funktion $e^x$ ist ihre eigene Ableitung. Mit $k > 0$ wächst sie, mit $k < 0$ zerfällt sie. Standard in Naturwissenschaften.',
      },
    },
    examples: {
      bacteria: {
        ...
        step2: 'Die Exponentialfunktion aufstellen — $t$ zählt die Stunden:',
        step3: 'Für $t = 5$ (nach 5 Stunden) einsetzen: $2^5 = 32$:',
        step4: 'Nach 5 Stunden gibt es 16.000 Bakterien:',
        mia_comment: 'Von 500 auf 16.000 in nur 5 Stunden! Das zeigt, warum exponentielles Wachstum so überraschend ist. Bei Servern läuft das ähnlich — Spielerzahlen können schneller wachsen, als man Server nachbestellen kann.',
      },
      radioactive: {
        ...
        step4: 'Nach 24 Tagen sind nur noch 25 g übrig — ein Achtel des Startwerts:',
    ...
    realworld: {
      ...
      battery: {
        ...
        desc: 'Dein Handy-Akku verliert pro Stunde etwa 5% seiner Ladung. Nach 14 Stunden ist noch etwa die Hälfte übrig — das ist kein linearer Abfall, sondern exponentieller Zerfall.',
      },
      pandemic: {
    ...
    mistakes: {
      ...
      wrong_growth_factor: {
        ...
        why: 'Bei 3% Wachstum ist der Faktor $1{,}03$, nicht $3$! Mit $b = 3$ würde sich der Wert verdreifachen statt um 3% wachsen. Immer $1 + \\frac{p}{100}$ rechnen.',
      },
    },
  },
};
