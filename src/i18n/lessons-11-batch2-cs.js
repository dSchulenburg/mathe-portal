export const batch11b = {
  ...
  '11-bedingte-wahrscheinlichkeit': {
    ...
    examples: {
      medical_test: { title: 'Lékařský test — klam bazické míry', context: 'Test na nemoc je 99% správný. Nemoc postihuje 1% populace. Pokud je test pozitivní — jak pravděpodobné je, že jsi opravdu nemocný?', step1: 'Data: $P(K) = 0{,}01$ (nemoc), $P(+ \\mid K) = 0{,}99$ (senzitivita), $P(+ \\mid \\bar{K}) = 0{,}05$ (false positive rate).', step2: 'Úplná pravděpodobnost pozitivního výsledku — obě cesty (nemocný + zdravý):', step3: 'Bayesova věta — hledáme $P(K \\mid +)$:', step4: 'Výsledek: Jen 16{,}7% pravděpodobnost, že jsi opravdu nemocný — navzdory 99% přesnosti testu!', amir_comment: 'To je klam bazické míry! Test je super přesný, ale protože nemoc je tak vzácná ($P(K) = 1\\%$), většina pozitivních testů jsou false positives. V ML světě to znamená: Precision a recall nejsou totéž!' },
    ...
    mistakes: {
      ...
      ignore_base_rate: { wrong: 'Ignorování bazické míry (Base Rate Fallacy)', correct: 'Vždy zohledni $P(A)$ — apriorní pravděpodobnost', why: 'Test s 99% přesností zní působivě, ale pokud nemoc postihuje jen 1%, je $P(K \\mid +) \\approx 16{,}7\\%$. Nízká bazická míra $P(K) = 0{,}01$ dominuje výsledku. Bez prioru získáš úplně zkreslený odhad.' },
    },
  },
