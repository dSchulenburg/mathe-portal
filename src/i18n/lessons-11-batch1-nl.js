export const batch11a = {
  '11-ableitungsregeln': {
    ...
    explanation: {
      ...
      quotient_rule: 'Voor breuken van functies is er de quotiëntregel. Ezelsbruggetje: "NAT min TAN door N kwadraat" (N = noemer, T = teller, A = afgeleide). Anders dan bij de productregel komt het hier op de volgorde aan — het min-teken maakt de formule asymmetrisch:',
    ...
    concepts: {
      ...
      quotient_rule: { title: 'Quotiëntregel', desc: 'Voor breuken: noemer keer afgeleide van de teller, min teller keer afgeleide van de noemer, gedeeld door de gekwadrateerde noemer. Het min-teken is het verschil met de productregel — en de meest voorkomende foutenbron. Overal nodig waar iets "per" iets anders staat: kosten per stuk, snelheid, concentratie.' },
    ...
    examples: {
      ...
      quotient_rule: {
        title: 'Gebroken rationale functie differentiëren met de quotiëntregel',
        context: 'Amir meet hoeveel verzoeken zijn server per verstreken seconde aankan — een grootheid per een andere, dus een breuk.',
        step1: 'Eerst benoem je teller en noemer. Wie dat overslaat, verwisselt ze later:',
        step2: 'Allebei apart differentiëren — dat is het makkelijke deel:',
        step3: 'Nu invullen: noemer keer afgeleide van de teller, min teller keer afgeleide van de noemer, alles gedeeld door $v^2$:',
        step4: 'Haakjes uitwerken en samenvoegen. De noemer blijft als kwadraat staan, die werk je niet uit:',
        amir_comment: 'Belangrijk: de noemer blijft $(x-1)^2$. Vroeger werkte ik hem altijd netjes uit en maakte ik het vereenvoudigen daarmee onmogelijk. Bij het functieonderzoek wil je de nulpunten van de noemer kunnen zien — als factor, niet als polynoom.',
      },
      chain_rule: {
    ...
    mistakes: {
      ...
      quotient_sign: {
        wrong: 'Teller van de quotiëntregel verwisseld: $u \\cdot v\' - u\' \\cdot v$',
        correct: 'Noemer keer afgeleide van de teller eerst: $u\' \\cdot v - u \\cdot v\'$',
        why: 'De productregel is symmetrisch — je mag de twee termen verwisselen, het resultaat blijft hetzelfde. Bij de quotiëntregel staat er een min-teken, en daarmee ligt de volgorde vast. Verwissel je ze, dan krijg je precies het tegengestelde van de juiste afgeleide. Het verraderlijke eraan: de term ziet er plausibel uit, je rekent correct verder, en toch klopt aan het eind elk teken niet. Een maximum wordt een minimum.',
        amir_warning: 'Controleer het op een eenvoudige plek. Bij $f(x) = \\frac{x}{x+1}$ is de functie overal stijgend, dus moet $f\'$ positief zijn. Komt er bij jou iets negatiefs uit, dan heb je de teller omgedraaid — dat kost je tien seconden en redt de hele opgave.',
      },
    },
  },
