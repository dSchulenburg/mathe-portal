...
import { batch0 } from '../lessons-10-batch0-ru';
...
export default {
  ...
  lesson: {
    ...
    objectivesSubtitle: 'После этой темы ты сможешь...',
    explanation: 'Объяснение',
    concepts: 'Ключевые понятия',
    examples: 'Примеры решений',
    examplesSubtitle: 'Решено шаг за шагом',
    realWorld: 'Где ты это встретишь?',
    mistakes: 'Типичные ошибки',
    mistakesSubtitle: 'Здесь часто ошибаются...',
    prerequisites: 'Предварительные знания',
    prerequisitesSubtitle: 'Это ты уже должен уметь',
    connections: 'Мосты к другим темам',
    connectionsSubtitle: 'Где та же идея встречается снова',
